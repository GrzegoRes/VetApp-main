package com.vetapp.vet.authentication;
 ...
 */
@ApplicationScoped
@BasicAuthenticationMechanismDefinition(realmName = "VET APP")
@DatabaseIdentityStoreDefinition(
        dataSourceLookup = "jdbc/VetAnimalApp",
        callerQuery = "select password from vet where login = ?",
